          ...
          <Col sm={24} md={24} lg={12} xl={12}>
            <div className="features__desc">
              ...
              <p className="features__desc-copy">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore ex numquam mollitia
                inventore nemo accusantium consequatur et, sint quaerat, dolores, enim sunt
                praesentium vitae officiis incidunt? Molestias possimus incidunt sapiente!
              </p>
            </div>
          </Col>
        </Row>
        <Row justify="space-between" gutter={[0, 32]}>
          ...
          <Col xs={24} md={24} lg={6} xl={6}>
            <div className="features__card">
              ...
              <p className="features__card-text">Comparte tu carrera, trabajos, proyectos</p>
            </div>
          </Col>
          <Col xs={24} md={24} lg={6} xl={6}>
            <div className="features__card">
